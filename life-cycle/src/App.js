...
export default class App extends React.Component {
  ...
  render() {
    ...
    return (
    <div >
      <button onClick={this.mountCounter} disable={this.state.mount}>Mount Counter</button>
      <button onClick={this.unmountCounter} disable={!this.state.mount}>Unmount Counter</button>
